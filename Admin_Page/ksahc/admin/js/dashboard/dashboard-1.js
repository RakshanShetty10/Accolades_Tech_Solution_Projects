 ...
 var dzChartlist = function(){
	...
	var projectChart = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['#3AC977', 'var(--primary)', '#FF5E5E','#FF9F00', '#E74C3C', '#40E0D0', '#BE75FF' ],
			labels: ["Daily", "Weekly", "Monthly", "3 Month", "4 Month", "6 Month", "Yearly"],
			dataLabels: {
				enabled: false,
			},
        };
	...
	$.ajax({
		url:"ajax/get-editing-status.php",
		method:"POST",
		success:function(datas)
		{
			data = JSON.parse(datas);
	...
	var projectStatus = function(){
       ...
       plotOptions: {
		 ...
		 legend: {
			...
			colors: ['#3AC977', 'var(--primary)', '#FF5E5E','#FF9F00', '#E74C3C', '#40E0D0' ],
			labels: ["Pending", "Completed", "Not Yet Started", "Still Editing", "Not Specified", "In Review"],
			dataLabels: {
				enabled: false,
			},
        };
		var chartBar1 = new ApexCharts(document.querySelector("#projectStatus"), options);
		chartBar1.render();
	 
	}
	$.ajax({
		url:"ajax/get-telecast-status.php",
		method:"POST",
		success:function(datas)
		{
			data = JSON.parse(datas);
	...
	var projectStatusTelecast = function(){
		var options = {
			series: data,
         chart: {
			type: 'donut',
       ...
       plotOptions: {
		 ...
		 legend: {
			...
			colors: ['#3AC977', 'var(--primary)', '#FF5E5E','#FF9F00' ],
			labels: ["Pending", "Done", "Waiting For Progress", "Program Received"],
			dataLabels: {
				enabled: false,
			},
        };
		var chartBar1 = new ApexCharts(document.querySelector("#projectStatusTelecast"), options);
		chartBar1.render();
