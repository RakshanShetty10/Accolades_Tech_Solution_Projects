(function($) {
 ...
 var dlabChartlist = function(){
	...
	$.ajax({
		url: 'ajax/donation-status.php',
		method: 'POST',
		dataType: 'json',
		success: function (data) {
	
			var regTypeA = data.regTypeA;
			...
			for (var i = 0; i < 12; i++) {
				var month = i; 
				var monthName = new Date(currentYear, month).toLocaleString('default', { month: 'long' }); 
				
				dateLabels.push([month, monthName]);
			}
			...
			$("#flotLine1").bind("plothover", function (event, pos, item) {
				if (item) {
