...
$practitioner_name = "Guest User";
$practitioner_mobile_number = "";
$practitioner_email_id = "";
$id = "";
...
if (!empty($_SESSION['_id'])) {
    ...
    if ($practitioner_result && mysqli_num_rows($practitioner_result) > 0) {
        ...
        $practitioner_mobile_number = $practitioner_row['practitioner_mobile_number'];
        $practitioner_email_id = $practitioner_row['practitioner_email_id'];
    }
}
...
if (isset($_POST['submit'])) {
    ...
    if ($res2['slot_count'] >= $no_of_people) {
        ...
        if (mysqli_query($conn, "INSERT INTO appointment (appoint_name, appoint_mobile, appoint_email, 
            ...
            '$description', '$slot', '$status', '$name', '$date_c', '$date')")) {
            ...
            echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        ...
                        window.location = 'calendar-user-no-header.php';
                    });
                });
            </script>";
        } else {
...
<head>
    ...
    <meta name="description" content="Appointment Calendar">
    <meta name="format-detection" content="telephone=no">
    <title><?php echo $site_full; ?> - Appointment Calendar</title>
                ...
                <form method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input autocomplete='off' type="text" class="form-control" pattern="[0-9]{6,13}" title="Accept 6 to 13 digit number" maxlength="13" name="phone" value="<?php echo $practitioner_mobile_number ?>" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-xl-6">
                            <label class="form-label">Mail<span class="text-danger">*</span></label>
                            <input autocomplete='off' type="email" class="form-control" required name="mail" value="<?php echo $practitioner_email_id ?>" title="Enter valid email">
                        </div>
                        <div class="col-xl-6">
