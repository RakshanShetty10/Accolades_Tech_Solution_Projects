                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <button class="nav-link" id="nav-five-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="nav-five" aria-selected="false">CDE
                                                    Points</button>
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="nav-one" role="tabpanel"
                                                ...
                                                <?php
                                                    ...
                                                    if (mysqli_num_rows($resDentists) > 0) {
                                                        ...
                                                        ?>
                                                <div class="row mt_40">
                                                    <h5 style="font-weight: 500;" class="mb_20">Personal Information
                                                    </h5>
                                            ...
                                            <div class="tab-pane fade" id="nav-two" role="tabpanel"
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                <div class="row mt_40">
                                                    <h5 style="font-weight: 500;" class="mb_20">Residential Information
                                                    </h5>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group row">
                                                ...
                                                <div class="row mt_40">
                                                    <div class="col-lg-5">
                                                        <h5 style="font-weight: 500;" class="mb_20">Professional
                                                            Information
                                                        </h5>
                                                    </div>
                                                    <div class="col-lg-7">
                                            ...
                                            <div class="tab-pane fade" id="nav-five" role="tabpanel"
                                                aria-labelledby="nav-five-tab" tabindex="0">
                                                <div class="row mt_40">
                                                    <h5 style="font-weight: 500;" class="mb_20">CDE Points
                                                    </h5>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label">Total Points
                                                                Obtained</label>
                                                            <div class="col-sm-7">
                                                                <span class="form-control-plaintext">
                                                                    <?php $resPoints = mysqli_query($conn, "SELECT COALESCE(SUM(cde_points),0) AS points FROM 
                                                                        cde_points WHERE practitioner_id = '$id'");
                                                                    if(mysqli_num_rows($resPoints)>0){

                                                                        $resPoints = mysqli_fetch_assoc($resPoints);

                                                                        echo $resPoints['points'];
                                                                    } else{ echo "0";}?>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label">Used Points</label>
                                                            <div class="col-sm-7">
                                                                <span class="form-control-plaintext">0</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label">Total Available
                                                                Points</label>
                                                            <div class="col-sm-7">
                                                                <span class="form-control-plaintext">0</span>
                                                            </div>
