...
<div class="form-group address-field">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="college_id" name="college_id">
                            <option value="">Search or select a college</option>
                            <?php
                        ...
                        <div class="help-text">Type to search for your college</div>
                    </div>

                    <div class="form-group">
                        <label for="university_id">University</label>
                        <select class="form-control" id="university_id" name="university_id">
                            <option value="">Search or select a university</option>
                            <?php
                        ...
                        <div class="help-text">Type to search for your university</div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize Select2 for college and university dropdowns
            $(document).ready(function() {
                $('#college_id').select2({
                    ...
                    language: {
                        ...
                        noResults: function() {
                            return "No college found with this name";
                        },
                        searching: function() {
                            return "Searching...";
                        }
                ...
                $('#university_id').select2({
                    ...
                    language: {
                        ...
                        noResults: function() {
                            return "No university found with this name";
                        },
                        searching: function() {
                            return "Searching...";
                        }
