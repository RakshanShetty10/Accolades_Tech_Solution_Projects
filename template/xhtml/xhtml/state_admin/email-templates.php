    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <a href="https://ksahc.karnataka.gov.in" style="background-color: #375bd1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">
    Visit KSAHC Website
</a>
