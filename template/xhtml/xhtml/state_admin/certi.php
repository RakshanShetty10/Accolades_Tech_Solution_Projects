...
<div class="col-xl-12">
    <div class="card">
        <div class="card-header border-0">
            ...
            <div class="d-flex">
                <form id="bulkActionForm" class="me-2">
                ...
                <table id="taskTable" class="table">
                    <thead class="table-light text-nowrap">
                        <tr>
                            ...
                            <th class="mw-100">Certification  Type</th>
                            <th class="mw-100">Contact </th>
                            <th class="mw-100">Apply Date</th>
                    ...
                    <tbody class="text-nowrap">
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input practitioner-checkbox" value="1">
                                </div>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td>Medical</td>
                            <td>
                                <div><i class="fas fa-envelope text-muted mr-1"></i> john.doe@example.com</div>
                                <div><i class="fas fa-phone text-muted mr-1"></i> +1-555-123-4567</div>
                            </td>
                            <td>15 Mar 2025</td>
                            <td>Pending</td>
                            <td>
							<div class="btn-group">
								 ...
								 <button class="btn btn-sm btn-warning send-remark-btn" title="Send Remark" 
										 data-email="william.johnson@example.com" 
										 data-name="William Johnson" 
										 data-id="5">
									view Certificate
								 </button>
							 </div>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input practitioner-checkbox" value="2">
                                </div>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td>Dental</td>
                            <td>
                                <div><i class="fas fa-envelope text-muted mr-1"></i> jane.smith@example.com</div>
                                <div><i class="fas fa-phone text-muted mr-1"></i> +1-555-987-6543</div>
                            </td>
                            <td>10 Apr 2025</td>
                            <td>Approved</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input practitioner-checkbox" value="3">
                                </div>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td>Pharmacy</td>
                            <td>
                                <div><i class="fas fa-envelope text-muted mr-1"></i> michael.brown@example.com</div>
                                <div><i class="fas fa-phone text-muted mr-1"></i> +1-555-456-7890</div>
                            </td>
                            <td>20 Feb 2025</td>
                            <td>Rejected</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input practitioner-checkbox" value="4">
                                </div>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td>Medical</td>
                            <td>
                                <div><i class="fas fa-envelope text-muted mr-1"></i> emily.davis@example.com</div>
                                <div><i class="fas fa-phone text-muted mr-1"></i> +1-555-321-6547</div>
                            </td>
                            <td>05 Jan 2025</td>
                            <td>Pending</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input practitioner-checkbox" value="5">
                                </div>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td>Dental</td>
                            <td>
                                <div><i class="fas fa-envelope text-muted mr-1"></i> william.johnson@example.com</div>
                                <div><i class="fas fa-phone text-muted mr-1"></i> +1-555-654-3210</div>
                            </td>
                            <td>25 Dec 2024</td>
                            <td>Approved</td>
                            <td>
